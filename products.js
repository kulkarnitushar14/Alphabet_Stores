// ============================================================
// ALPHABET STORE — Shared Product Data & Cart Logic
// ============================================================
...
function showToast(msg) {
  ...
  if (!t) {
    ...
    t.id = 'toast-msg';
    t.style.cssText = 'position:fixed;bottom:1.5rem;left:50%;transform:translateX(-50%);background:#121212;color:#fff;padding:0.6rem 1.4rem;font-size:13px;letter-spacing:0.05em;z-index:9999;border-bottom:2px solid #D4AF37;pointer-events:none;transition:opacity 0.3s';
